...
export function Footer() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <Link href="https://instagram.com/bluehillsai" className="text-blue-300 hover:text-white transition-colors">
                ...
                <Link href="https://x.com/bluehillsai" className="text-blue-300 hover:text-white transition-colors">
                  <Twitter className="h-5 w-5" />
                </Link>
                <Link href="https://www.facebook.com/profile.php?id=61574334968139" className="text-blue-300 hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  <Link href="https://www.youtube.com/@bluehillsai" className="text-blue-300 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 576 512">
      <path d="M549.7 124.1c-6.3-23.7-24.9-42.3-48.6-48.6C458.7 64 288 64 288 64s-170.7 0-213.1 11.4c-23.7 6.3-42.3 24.9-48.6 48.6C16 166.5 16 256 16 256s0 89.5 10.3 131.9c6.3 23.7 24.9 42.3 48.6 48.6C117.3 448 288 448 288 448s170.7 0 213.1-11.4c23.7-6.3 42.3-24.9 48.6-48.6C560 345.5 560 256 560 256s0-89.5-10.3-131.9zM232 336V176l142 80-142 80z" />
    </svg>
  </Link>
              </div>
            </div>
...
<li><a href="#" className="text-blue-200 hover:text-white transition-colors">Sales & Website Demo Videos</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/about-us" className="text-blue-200 hover:text-white transition-colors">About Us</a></li>
                <li><a href="#" className="text-blue-200 hover:text-white transition-colors">Why Choose Us</a></li>
                <li><a href="#" className="text-blue-200 hover:text-white transition-colors">Our Clients</a></li>
