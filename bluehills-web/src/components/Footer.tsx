        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <Link href="https://instagram.com/bluehills.ai" className="text-blue-300 hover:text-white transition-colors">
                ...
                <Link href="https://www.facebook.com/" className="text-blue-300 hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
